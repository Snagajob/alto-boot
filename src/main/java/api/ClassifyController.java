...
public class ClassifyController {
    ...
    public void classifyRoute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        //Data holders
        HashMap<String, ArrayList<String>> labeledDocs = new HashMap<>();
        ArrayList<String> testingIdList = new ArrayList<>();

        HashMap<String, String> updateTestingIdToLabel = new HashMap<>();
        HashMap<String, ArrayList<Double>> updateTestingIdToProbs = new HashMap<>();

        TreeMap<String, String> idToGoldenLabelMap = new TreeMap<>();
        HashMap<String, HashSet<String>> userLabelToIds= new HashMap<>();
        HashMap<String, HashSet<String>> goldenLabelToIds= new HashMap<>();
        Set<String> trainingLabelSet = new HashSet<>();
    ...
    public TreeMap<String, String> getDocLabelMap(String docToLabelMapStr) {
        ...
        TreeMap<String, String> idToLabelMap = new TreeMap<>();
    ...
    public HashMap<String, Integer> mapLabelStrToInt(
        ...
        HashMap<String, Integer> labelStrToInt = new HashMap<>();
        int labelInt = 0;
